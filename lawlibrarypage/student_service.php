...
<?php /* Template Name: Student Service */ ?>
...
<h3 class="menu-actions-label"><?php _e("Interact:"); ?><br /></h3>
<h3 style="display:inline"><?php wp_nav_menu (array('theme_location' => 'student_actions', 'container_class' => 'menu-actions-container')); ?>
</h3>
...
<?php if ( is_page( '4084' ) || '4084' == $post->post_parent )  {

  $children = wp_list_pages("title_li=&child_of=4084&echo=0&depth=1");
  ...
  <h3 class="menu-actions-label"><?php _e("Law Student Service Descriptions"); ?></h3>
<div class=sublist>
...
<h1><?php if (!is_page('4084')) echo $titlename; ?></h1>
