...
<div class="entry page"><?php $term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) ); ?>
<h2><?php _e("Database Description Search Results: "); ?><?php echo $term->name; ?></h2>
</div>
...
<?php
$my_id = 5806;
$post_id_5806 = get_post($my_id);
$content = $post_id_5806->post_content;
