				...
				<?php if (is_single()) { ?>
					...
					<?php } else { ?>
						<div class="postmeta">
							...
							<span class="author"><?php _e("By", "notesblog");?> <a href="<?php the_author_url(); ?>" title="<?php the_author(); ?>" class="author"><?php the_author(); ?><?php _e(".") ?></a></span>
							<span class="categories"><?php _e("Filed in", "notesblog");?> <?php the_category(', '); ?><?php _e(".") ?></span>
				...
				<?php } else { ?>
					...
					<div class="postmeta">
						...
						<span class="author"><?php _e("By ") ?><?php the_author_posts_link(); ?><?php _e(".") ?></a></span>
							<span class="timestamp"><?php the_time(__('F jS, Y', 'notesblog')) ?> </span></div>
				<?php } ?>
